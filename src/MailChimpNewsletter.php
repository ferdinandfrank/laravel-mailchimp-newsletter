...
class MailChimpNewsletter {
    ...
    /** * @var \FerdinandFrank\MailChimpNewsletter\MailChimpNewsletterListCollection */
    protected $lists;

    public function __construct(MailChimp $mailChimp, MailChimpNewsletterListCollection $lists) {
    ...
    public function subscribeOrUpdate(string $email, array $mergeFields = [], string $listName = '', array $options = []
        ...
        $response =
            $this->mailChimp->put("lists/{$list->getId()}/members/{$this->getSubscriberHash($email)}", $options);
    ...
    public function updateEmailAddress(string $currentEmailAddress, string $newEmailAddress, string $listName = '') {
        ...
        $response =
            $this->mailChimp->patch("lists/{$list->getId()}/members/{$this->getSubscriberHash($currentEmailAddress)}", [
